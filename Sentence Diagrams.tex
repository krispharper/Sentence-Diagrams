...
\begin{document}
    ...
    \begin{sentencediagram}{Call me Ishmael}{Herman Melville}{Moby Dick}
        \begin{tikzpicture}
            \tikzstyle{every node} = [above=-0.15cm]
            \draw[ultra thick] (-3, 0) -- (3, 0)
                node[pos=0.2, text=subjectnoun]{\strut (you)}
                node[pos=0.4, text=predicateverb]{\strut Call}
                node[pos=0.6, text=directobject]{\strut me}
                node[pos=0.8, text=noun]{\strut Ishmael};
