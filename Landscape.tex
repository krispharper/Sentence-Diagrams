...
\begin{document}
    ...
    \begin{sentencediagram}{1.75}{2}{It was a queer, sultry summer, the summer they electrocuted\\the Rosenbergs, and I didn't know what I was doing in New York}{Sylvia Plath}{The Bell Jar}
        \begin{tikzpicture}
            ...
            \draw[ultra thick] (0, 3.25) -- (0, 2);
            \draw[loosely dotted, ultra thick] (0.5, 4) -- (0.5, 2.5);
            \draw[ultra thick] (4, 3.25) -- (4, 2.5);
            \draw[ultra thick] (5, 2.5) -- (6.2, 1.3)
                node[sloped, pos=0.6, text=article]{\strut the};
            \draw[ultra thick] (0.5, 2.5) -- (0.5, 1.25);
            \draw[ultra thick] (0.5, 1.25) -- (0.25, 1);
            \draw[ultra thick] (0.5, 1.25) -- (0.75, 1);

            \draw[ultra thick] (-7, 1) -- (1.25, 1)
                node[pos=0.08, text=subjectnoun]{\strut It}
                node[pos=0.35, text=copula]{\strut was}
                node[pos=0.7, text=subjectcomplement]{\strut summer}
                node[pos=0.85]{(}
                node[pos=0.965]{)};
            \draw[ultra thick] (-5.5, 1.75) -- (-5.5, 0.5);
            \draw[ultra thick] (-3.25, 1.75) -- (-2.5, 1);
            \draw[ultra thick] (-0.5, 1) -- (0.5, 0)
                node[sloped, pos=0.6, text=article]{\strut a};
            \draw[ultra thick] (-1.5, 1) -- (0, -0.5);
            \draw[ultra thick] (0, -0.5) -- (0.5, -0.5);
            \draw[ultra thick] (0, -0.5) -- (0, -1);
            \draw[loosely dotted, ultra thick] (0.5, -0.5) -- (0, -1);
            \draw[ultra thick] (0.5, -0.5) -- (2, -2)
                node[sloped, pos=0.5, text=adjective]{\strut queer};
            \draw[ultra thick] (0, -1) -- (1.5, -2.5)
                node[sloped, pos=0.5, text=adjective]{\strut sultry};

            \draw[loosely dotted, ultra thick] (-5, 1) -- (-5, -0.75);
            \draw[ultra thick] (-5, -0.75) -- (-4, -0.75)
                node[pos=0.55, text=conjunction]{\strut and};
            \draw[loosely dotted, ultra thick] (-4, -0.75) -- (-4, -1.75);

            \draw[ultra thick] (-4.5, -2.5) -- (0, -2.5)
                node[pos=0.1, text=subjectnoun]{\strut I}
                node[pos=0.45, text=copula]{\strut was}
                node[pos=0.8, text=predicateverb]{\strut doing};
            \draw[ultra thick] (-3.5, -1.75) -- (-3.5, -3);
            \draw[ultra thick] (-2.5, -2.5) -- (-1, -4)
                node[sloped, pos=0.6, text=pronoun]{\strut what};
            \draw[ultra thick] (-1, -2.5) -- (0, -3.5)
                node[sloped, pos=0.7, text=preposition]{\strut in};
            \draw[ultra thick] (0, -3.5) -- (2.75, -3.5)
                node[pos=0.5, text=noun]{\strut New York};
            \draw[ultra thick] (-3.25, -2.5) -- (-3.25, -3.25);
            \draw[ultra thick] (-3.25, -3.25) -- (-3.5, -3.5);
            \draw[ultra thick] (-3.25, -3.25) -- (-3, -3.5);

            \draw[ultra thick] (-8, -3.5) -- (-2.5, -3.5)
                node[pos=0.1, text=subjectnoun]{\strut I}
                node[pos=0.35, text=modalverb]{\strut did}
                node[pos=0.6, text=predicateverb]{\strut know};
            \draw[ultra thick] (-7, -2.75) -- (-7, -4);
            \draw[ultra thick] (-3.75, -2.75) -- (-3.75, -3.5);
            \draw[ultra thick] (-6, -3.5) -- (-4.8, -4.7)
